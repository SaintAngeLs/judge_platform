...
class Submission(models.Model):
    ...
    def send_submission_email(self):
        ...
        to_email = self.user.email  # Assuming user has an email field
        ...
        html_message = render_to_string('submission_email.html', context)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.points is not None:  # Assuming points are only assigned after the submission is judged
